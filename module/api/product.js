...
{$lookup: {
    ...
    if(product.length>0){
        ...
        {
           DB_phien.update({id:product[0].phien_doc.id}, {time:func.getTime(),endtime:(func.getTime()+product[0].timedaugia),run:1}, {multi:true}, function(err, doc){
...
product[0].phien_doc.endtime=func.getTime()+product[0].timedaugia;
